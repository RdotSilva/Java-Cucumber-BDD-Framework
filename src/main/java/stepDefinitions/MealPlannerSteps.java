...
public class MealPlannerSteps extends DriverFactory{
	...
	public void user_logged_in_as_a_registered_user() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@When("^user navigates to the eatthismuch\\.com website$")
	public void user_navigates_to_the_eatthismuch_com_website() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void user_should_be_presented_with_the_Meal_Planner_page() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
